...
import net.samiayoub.school.service.StudentCourseDetailsService;
...
public class StudentCourseDetailsController {
    ...
    public void deleteStudentCourseDetails(@PathVariable Long id) {
        studentCourseDetailsService.deleteById(id);
    }

    @GetMapping("/{id}")
    public StudentCourseDetailsResponse getStudentCourseDetails(@PathVariable Long id) {
