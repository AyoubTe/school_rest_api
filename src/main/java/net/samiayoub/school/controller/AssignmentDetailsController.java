...
import net.samiayoub.school.service.AssignmentDetailsService;
...
public class AssignmentDetailsController {
    ...
    public void deleteAssignmentDetails(@PathVariable Long id) {
        assignmentDetailsService.deleteAssignmentDetailsById(id);
    }

    @GetMapping("/{id}")
    public AssignmentDetailsResponse getAssignmentDetails(@PathVariable Long id) {
