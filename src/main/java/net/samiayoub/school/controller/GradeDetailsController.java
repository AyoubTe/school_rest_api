...
import net.samiayoub.school.service.GradeDetailsService;
...
public class GradeDetailsController {
    ...
    public void deleteGradeDetails(@PathVariable Long id) {
        gradeDetailsService.deleteGradeDetailsById(id);
    }

    @GetMapping("/{id}")
    public GradeDetailsResponse getGradeDetails(@PathVariable Long id) {
